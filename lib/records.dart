...
class RecordsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Get.put(recordsController());
    recordsC = Get.find<recordsController>();
    for (String element in homeData.users.keys) {
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: DropdownButton2<String>(
                          ...
                          items: _bossOrUserList().map((String value) {
                            return DropdownMenuItem<String>(
                              value: value,
                              child: Container(
                                  width: 100,
                      ...
                      Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            TextButton(
                              child: Text(
                                '时间${recordsC.asc.value == false ? '逆' : '正'}序',
                              ),
                              onPressed: () {
                                recordsC.asc.value = !recordsC.asc.value;
                              },
                ...
                Expanded(
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      } else if (recordsC.records[index].canUndo == 0) {
                        return const SizedBox.shrink();
                      }
...
class recordsCard extends StatelessWidget {
  ...
  String _parse_time(String time) {
    ...
    String formattedDateTime =
        DateFormat('yyyy-MM-dd HH:mm:ss').format(utcPlus8DateTime);
                    ...
                    showDialog(
                        ...
                        builder: (BuildContext context) {
                          return AlertDialog(
                            ...
                            content: Text(
                                '确定要删除用户"$username"在${_parse_time(time)}对${homeData.bosses[bossID - 1].name.value}造成$damage伤害的记录吗？\n该操作不可逆'),
                            actions: <Widget>[
                              Padding(
                                ...
                                child: TextButton(
                                  onPressed: () async {
                                    ...
                                    var sendReq = SendReq(1,
                                        '${getx.appSettings.value.remoteServerUrl}/v1/deleterecord',
                                        query: <String, String>{
                                          'record_id': '$id'
                                        },
                                        token: getx.appSettings.value.token);
                                    var resp = await sendReq.send();
                                    if (resp?.statusCode == 200) {
                                      for (int i = 0;
                                          i < homeData.records.length;
                                          i++) {
                                        if (homeData.records[i].id == id) {
                                          homeData.records.removeAt(i);
                                        }
                                      }
                                      for (int i = 0;
                                          i < recordsC.records.length;
                                          i++) {
                                        if (recordsC.records[i].id == id) {
                                          recordsC.records.removeAt(i);
                                        }
                                      }
                                      var cancel1 =
                        ...
                        children: [
                          GestureDetector(
                                ...
                                showDialog(
                                    ...
                                    builder: (BuildContext context) {
                                      return GestureDetector(
                                        ...
                                        onLongPress: () async {
                                          ...
                                          var result =
                                              await ImageGallerySaver.saveImage(
                                                  getx.appSettings.value
                                                          .eTagToPic[
                                                      homeData.users[username]
                                                          ?.picEtag.value]!,
                                                  name:
                                        ...
                                        child: PhotoView(
                                            imageProvider: MemoryImage(getx
                                                    .appSettings
                                                    .value
                                                    .eTagToPic[
                                                homeData.users[username]
                            ...
                            child: ClipRRect(
                              ...
                              child: homeData.users[username]?.picEtag.value ==
                                      ''
                                  ? Image.asset(
                                      'images/64135784.png',
                                      fit: BoxFit.cover,
                        ...
                        children: [
                          GestureDetector(
                                      ...
                                      onLongPress: () async {
                                        ...
                                        var result =
                                            await ImageGallerySaver.saveImage(
                                                getx.appSettings.value
                                                        .eTagToPic[
                                                    homeData.bosses[bossID - 1]
                                                        .picETag]!,
                                                name:
                                                    '${timestamp}_${homeData.bosses[bossID - 1].name.value}',
                                                quality: 100);
                                        if (result['isSuccess'] == true) {
                                          var ok =
                                              BotToast.showText(text: '保存成功');
                            ...
                            child: ClipRRect(
                                ...
                                child: Image.memory(
                                  getx.appSettings.value.eTagToPic[
                                      homeData.bosses[bossID - 1].picETag]!,
                                  fit: BoxFit.cover,
                                )),
                          ),
                        ],
